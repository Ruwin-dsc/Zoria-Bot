...
function devcmd(content, cmdname) {
    write(content, 'black', 'bgBlue', `CMD DEV - ${cmdname}`, true);
}
...
module.exports = { devcmd, shards, used, error, warn, command, event, typo, client, db, slash };